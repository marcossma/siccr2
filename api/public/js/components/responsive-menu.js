        ...
        const admDropdown = nivel >= 1 ? `
            <li class="nav-dropdown">
                ...
                <ul class="nav-dropdown-menu">
                    ...
                    ${ehDirecao ? `<li><a href="/quadro-de-horarios">Quadro de horários</a></li>` : ""}
                ...
                <ul class="nav-menu" id="nav-menu-lista" role="list">
                    ...
                    <li class="nav-dropdown">
                        ...
                        <ul class="nav-dropdown-menu">
                            ...
                            ${ehDirecao ? `<li><a href="/relatorios-manutencao">Relatórios de manutenção</a></li>` : ""}
                        </ul>
                    </li>` : ""}
                    <li class="nav-dropdown">
                        <button class="nav-dropdown-toggle" aria-expanded="false" aria-haspopup="true">
                    ...
                    ${nivel >= 1 ? `<li><a href="/assistente">Assistente</a></li>` : ""}
