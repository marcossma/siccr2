class MenuNavegacaoAdm extends HTMLElement {
    connectedCallback() {
        ...
        const itens = [
            ...
            { href: "/ensalamento",     icone: "bi-grid-3x3-gap",   label: "Ensalamento" },
            { href: "/quadro-de-horarios", icone: "bi-table",       label: "Quadro de horários" },
            ...
            { href: "/adm/importar-financeiro", icone: "bi-cash-stack", label: "Importar financeiro" },
